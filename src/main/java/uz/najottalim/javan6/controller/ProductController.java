...
public class ProductController {
    ...
    public List<Product> getAllProductsByColumnName(@PathVariable Integer limit, @PathVariable Integer offset, @PathVariable String columnName){
        return productService.getAllProductsByColumnName(limit, offset, columnName);
    }
}
